...
if IMPORT_MASKFILES==0
    ...
    if strcmpi(ParamStruct_aug.ROIMASK,'OP1')
        roimask_OP1( pcsf_file,pwm_file,pgm_file,tsd_file,bmsk_file, [outpath,'/_group_level/masks/pipe_',PipeStruct_aug.PNAME{1}] );
    else
