function [subject_list, InputStruct_aug, PipeStruct_aug, ParamStruct_aug] = P0_fmri_populateDirectories( inputfile, pipelinefile, paramlist, outpath, push_overwrite )
%
% =========================================================================
...
if ~exist(fullfile(outpath,'_pipe_manager','pipe_key.mat'),'file')
    ...
    if ~isempty(ix)
        ...
        if isempty(pid) pid=0; end           % case where this is empty (deleted part of chain)
