...
for i=1:numel(e)
    if ~strcmpi(e(i).name,'sub-NCOV1F006_ses-V01')
        ...
        outfile = sprintf('texturial_matfiles_vox/%s_gm',prfix);
        fprintf(fid,'matlab -nodisplay -nojvm -singleCompThread -r "addpath /lustre03/project/6071833/nwc/NIFTI_tools; addpath /lustre03/project/6071833/nwc/tex_code; texmap_wrapper3( ''%s'', ''%s'', [11101:11141 11143:11175, 12101:12141 12143:12175], 1, ''%s'', 7, 7, [], [], ''HDE'', [0.10] ); exit;"\n',...
