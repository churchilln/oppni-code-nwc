...
mkdir('texturial_matfiles_u_aD');
e = dir('texturial_data/sub-*t1.nii');
fido = fopen('super_slurm_u_ad.sh','w');
load('tex_code/bwarr_u.mat');
...
for i=1:numel(e)
    if ~strcmpi(e(i).name,'sub-NCOV1F006_ses-V01')
        ...
        outfile = sprintf('texturial_matfiles_u_aD/%s_aD',prfix);
        ...
        if ~exist(outfile_fullname,'file')
            ...
            fprintf(fid,'matlab -nodisplay -nojvm -singleCompThread -r "addpath /lustre03/project/6071833/nwc/NIFTI_tools; addpath /lustre03/project/6071833/nwc/tex_code; load(''tex_code/bwarr_u.mat''); szoptim = mean(szarr,3); texmap_wrapper3( ''%s'', ''%s'', [10:13 17:18, 49:54,  11101:11141 11143:11175, 12101:12141 12143:12175], 0, ''%s'', [], [], [], [], ''KDE-GU'', [szoptim(:,%u)] ); exit;"\n',...
        ...
        outfile = sprintf('texturial_matfiles_u_aD/%s_aDaS',prfix);
        outfile_fullname = sprintf('%s_Output_Roi_byparc.mat',outfile);
        if ~exist(outfile_fullname,'file')
            ...
            fprintf(fid,'matlab -nodisplay -nojvm -singleCompThread -r "addpath /lustre03/project/6071833/nwc/NIFTI_tools; addpath /lustre03/project/6071833/nwc/tex_code; load(''tex_code/bwarr_u.mat''); szoptim = median(mean(szarr,3),2); texmap_wrapper3( ''%s'', ''%s'', [10:13 17:18, 49:54,  11101:11141 11143:11175, 12101:12141 12143:12175], 0, ''%s'', [], [], [], [], ''KDE-GU'', [szoptim(:)] ); exit;"\n',...
        ...
        outfile = sprintf('texturial_matfiles_u_aD/%s_aDaSaR',prfix);
        outfile_fullname = sprintf('%s_Output_Roi_byparc.mat',outfile);
        if ~exist(outfile_fullname,'file')
