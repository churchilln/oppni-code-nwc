...
%
% ** This script is now deprecated, only retained for next rev. cycle for
%    back-checking purposes. Superseded by newer script, which more correctly
%    estimates slice lag on 2d acq and can model pcasl effects
%
%% =========================================================================
