...
target = load_untouch_nii(targetfile);   % = nifti(targetfile);    [NWC ed]
xsize = int64( target.hdr.dime.dim(2) ); % = target.dat.dim(1);    [NWC ed]
ysize = int64( target.hdr.dime.dim(3) ); % = target.dat.dim(2);    [NWC ed]
zsize = int64( target.hdr.dime.dim(4) ); % = target.dat.dim(3);    [NWC ed]
...
niftiSpecs = target;                                              %[NWC ed]
% niftiSpecs.dim = [xsize ysize zsize];                            [NWC ed]
% niftiSpecs.mat = target.mat;                                     [NWC ed]
% niftiSpecs.mat_intent = target.mat_intent;                       [NWC ed]
% niftiSpecs.mat0 = target.mat0;                                   [NWC ed]
% niftiSpecs.mat0_intent = target.mat0_intent;                     [NWC ed]
