...
physio.log_files.cardiac = {'sub-035C_ses-2-bos_bold_BH.puls.log'};
physio.log_files.respiration = {'sub-035C_ses-2-bos_bold_BH.resp.log'};
...
physio.scan_timing.sqpar.Nscans = 195; 
